...
class AlientInvasion:
    ...
    def __init__(self):
        ...
        self.ship = Ship(self) # Ship access to the game's resources
    ...
    def run_game(self):
        ...
        while True:
            ...
            self.ship.blitme() # Calling blitme() function of Ship class / The ship appears on to of the background
