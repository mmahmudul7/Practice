...
int main()
{
    string s;
    cin >> s;              
    int frq[26] = {0};     // আমরা a থেকে z পর্যন্ত কাউন্ট করব। সবগুলো ভেলু শুরুতে ০ দিয়ে ইনিশিয়ালাইজ করা হয়েছে।  
    for (char c : s)       // স্ট্রিং এর উপর লুপ চালিয়ে প্রতিটি ক্যারেক্টার নিয়ে আসা হচ্ছে। 
    {
        frq[c - 'a']++;    // ফ্রিকোয়েন্সি এরেতে সেই ক্যারেক্টার এর Index যেয়ে তার কাউন্ট এর মান ১ বাড়িয়ে দেওয়া হচ্ছে। 
    }
